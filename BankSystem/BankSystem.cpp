...
size_t BankSystem::getNumerInputInRange(std::ostream& outputStream, std::istream& inputStream, size_t lowerBound, size_t upperBound) const {
	size_t option = 0;
	while (true) {
		outputStream << ">>";
...
void BankSystem::printMainMenu(std::ostream& outputStream) const {
	outputStream <<
		"1. Edit" << std::endl <<
		"2. List" << std::endl <<
		"3. Action" << std::endl <<
...
void BankSystem::printEditMenu(std::ostream& outputStream)const {
	outputStream <<
		"1. Customer" << std::endl <<
		"2. Account" << std::endl <<
		"3. Exit" << std::endl;
...
void BankSystem::printEditOptionMenu(std::ostream& outputStream)const {
	outputStream <<
		"1. Add" << std::endl <<
		"2. Delete" << std::endl <<
		"3. Exit" << std::endl;
...
void BankSystem::printListMenu(std::ostream& outputStream) const {
	outputStream <<
...
void BankSystem::printActionMenu(std::ostream& outputStream) const {
	outputStream <<
...
void BankSystem::handleCustomerEdit(std::ostream& outputStream, std::istream& inputStream) {
...
AccountType BankSystem::readAccountType(std::ostream& outputStream, std::istream& inputStream) const {
...
void BankSystem::handleAccountEdit(std::ostream& outputStream, std::istream& inputStream) {
	printEditOptionMenu(outputStream);
...
void BankSystem::handleEdit(std::ostream& outputStream, std::istream& inputStream) {
...
void BankSystem::handleList(std::ostream& outputStream, std::istream& inputStream)const {
...
void BankSystem::handleAction(std::ostream& outputStream, std::istream& inputStream) {
